...
<head>	
    ...
    <br><br>
        <p style="color:black; font-size:190%; font-family:pristina; text-align: center">User Login</p>
		...
		<button style="background-color:powderblue; border-color:blue; color:black;margin-left:46.2%" 
            type="submit" onclick="window.location.href = '../customer/register.php';">Click here to Register!</button>
           <br><br>
            <br><br>
            <br><br>
            <br><br>
